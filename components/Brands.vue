  ...
  <div class="container py-5">
    <div class="flex justify-between cursor-pointer group py-6">
      ...
      <div class="flex md:gap-2">
        ...
        ></i>
        <i
          class="bx bx-right-arrow-alt border px-1 sm:px-1 md:px-4 text-xl"
          @click="speedUp"
        ></i>
      </div>
    </div>
    <Vue3Marquee :duration="speed.value">
      <img src="/brand.png" alt="" class="px-2" />
      <img src="/brand1.png" alt="" class="px-2" />
      <img src="/brand2.png" alt="" class="px-2" />
    </Vue3Marquee>
  </div>
</template>
